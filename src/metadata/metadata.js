module.exports = {
  ...
  facts: {
    Residence:
      '<a href="https://www.google.com/maps/place/Innsbruck/@47.2855079,11.3437708,13z/data=!3m1!4b1!4m6!3m5!1s0x479d6ecfe1f8ca73:0x9d201c7d281d9b0d!8m2!3d47.2692124!4d11.4041024!16zL20vMGZobXk"><i class="fa fa-home fact-icon"></i>Innsbruck, AT</a>',
    ...
    StackOverflow:
      '<a href="https://stackoverflow.com/users/7425011/chrisil"><i class="fa-brands fa-stack-overflow fact-icon"></i>ChriSil</a>',
    Email:
      '<a href="mailto:chris.siller@alumni.fau.de"><i class="fa fa-envelope fact-icon"></i>chris.siller@alumni.fau.de</a>',
    Phone:
      '<a href="tel:>+43-670-3522557"><i class="fa fa-phone fact-icon"></i>+43 670 3522557</a>',
  },
  skills: [
    ['Python', 100],
    ['Rust', 30],
  ...
  positions: [
    ...
    },
    {
      ...
      contents:
        'Working Student in part time, helping on-site with user IT issues, migration of Operating Systems, maintenance and migration of databases and server environments.',
      subcontents: [],
    },
  ],
  theses: [
